...
const JobPostingsPage = () => {
    ...
    const [jobPostings, setJobPostings] = useState<JobPosting[]>([
        ...
        },
        {
            ...
            salaryMax: "$100k",
            description:
                "Join our design team to create beautiful and intuitive user experiences. You will work closely with product managers and developers to bring designs to life.",
            requirements:
                "3+ years of experience in UI/UX design, proficiency in Figma, Adobe Creative Suite, and strong portfolio demonstrating design thinking.",
            status: "active",
        ...
        },
        {
            ...
            requirements:
                "PhD or Masters in Data Science, Statistics, or related field. Experience with Python, R, SQL, and machine learning frameworks.",
            status: "draft",
        ...
        },
        {
            ...
            salaryMax: "$140k",
            description:
                "Join our DevOps team to build and maintain scalable infrastructure. You will work with cloud technologies and automation tools.",
            requirements:
                "4+ years of experience with AWS/GCP, Docker, Kubernetes, and CI/CD pipelines. Strong scripting skills in Python or Bash.",
            status: "closed",
