...
import { Search, Plus, Calendar, Users, Eye, Edit, X, Copy, RefreshCw, Code, Palette, Database, Server, BarChart3, ChevronLeft, ChevronRight } from 'lucide-react'
...
const JobPostingsPage = () => {
    ...
    const handleSaveJob = (isDraft: boolean) => {
        ...
        toast({
            ...
            description: isDraft ? "Your job posting has been saved as a draft" : "Your job posting has been published successfully",
        })
    }
            ...
            case 'expired':
                return (
                    <div className="flex space-x-2">
                        ...
                        <Button
                            size="sm"
                            onClick={() => handleJobAction(job.id, 'renew')}
                        >
                            Renew
                        </Button>
                    </div>
                                    ...
                                    <div className="mt-2 sm:flex sm:justify-between">
                                        <div className="sm:flex">
                                            <div className="flex items-center text-sm text-gray-500">
                                                ...
                                                {job.status === 'draft' ? 'Created' : 'Posted'} on {new Date(job.postedDate).toLocaleDateString()}
                                            </div>
                                            {job.status !== 'draft' && (
                                                <>
