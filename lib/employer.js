...
//         // console.dir(response.data, { depth: null }); // Log the full object
...
// // Example usage
// async function main() {
//     const mydata = await getCompanyApplicants(1); // Await the function to get the data

//     // if (mydata && mydata.applicants) { // Check if data exists and has applicants
//     //     mydata.applicants.forEach(applicant => {
//     //         console.log(`Job Title: ${applicant.job.title}, Status: ${applicant.status}`);
...
//     console.dir(mydata.applicants[0], { depth: null }); // Log the full object
// }
